...
namespace KeepFortissimo
{
...
#ifdef UNICODE
    static const wchar_t* kFailedToStartUpGameSystem[static_cast<u32>(Language::kLanguageMax)] =
    {
    ...
    static const wchar_t* kFailedToRegisterClass[static_cast<u32>(Language::kLanguageMax)] =
    {
    ...
    static const wchar_t* kFailedToCreateWindow[static_cast<u32>(Language::kLanguageMax)] =
    {
...
#else
    static const char* kFailedToStartUpGameSystem[static_cast<u32>(Language::kLanguageMax)] =
    {
    ...
    static const char* kFailedToRegisterClass[static_cast<u32>(Language::kLanguageMax)] =
    {
    ...
    static const char* kFailedToCreateWindow[static_cast<u32>(Language::kLanguageMax)] =
    {
